...
const testimonials = [
  ...
  },
  {
    ...
    content: "ChainShield's AI-powered platform has transformed our risk management. The integrations and automation have saved us countless hours."
  },
  {
    name: "David Wilson",
  ...
  },
  {
    ...
    content: "We've seen remarkable improvements in claims handling since switching to ChainShield. The AI analysis and instant payouts are particularly impressive."
  },
  {
  ...
  return (
    <section className="py-20 overflow-hidden bg-black">
      <div className="container px-4">
        ...
        >
          <h2 className="text-5xl font-normal mb-4">Trusted by Web3 Users</h2>
          <p className="text-muted-foreground text-lg">
            Join thousands of protected users on ChainShield
          </p>
        </motion.div>
